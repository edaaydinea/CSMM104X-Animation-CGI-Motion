#ifndef __RIGID_BODY_GR_VELOCITY_PROJECTION_COLLISION_RESOLVER_H__
#define __RIGID_BODY_GR_VELOCITY_PROJECTION_COLLISION_RESOLVER_H__
...
class RigidBodyGRVelocityProjectionCollisionResolver : public RigidBodyCollisionResolver
{
public:
