#ifndef __RIGID_BODY_LCP_COLLISION_RESOLVER_H__
#define __RIGID_BODY_LCP_COLLISION_RESOLVER_H__
...
class RigidBodyLCPCollisionResolver : public RigidBodyCollisionResolver
{
public:
